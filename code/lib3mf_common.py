...
'''
This module provides common functions for working with the lib3mf library in Python.
It includes functions for creating vertices, triangles, and beams, as well as utility functions for reading and writing 3MF files.
'''
